...
INSERT INTO creq (status, type, plant_id, admin_id, client_id, landscaper_id)
    VALUES ('inProgress', 'firstOne', 1, 1, 2, 3);
INSERT INTO creq (status, type, plant_id, admin_id, client_id, landscaper_id)
    VALUES ('inPurchase', 'firstOne', 2, 4, 5, 3);
INSERT INTO creq (status, type, plant_id, admin_id, client_id, landscaper_id)
    VALUES ('done', 'firstOne', 1, 1, 2, 3);
INSERT INTO creq (status, type, plant_id, admin_id, client_id, landscaper_id)
    VALUES ('inProgress', 'firstOne', 2, 4, 5, 3);
INSERT INTO creq (status, type, plant_id, admin_id, client_id, landscaper_id)
   VALUES ('done', 'planned', 2, 1, 2, 3);


INSERT INTO feedback (type, text, creq_id) VALUES ('positive', 'Thanks, everything is fine!', 11);
INSERT INTO feedback (type, text, creq_id) VALUES ('negative', 'Landscaper was too late, work is pustponed.', 12);

INSERT INTO preq (status, plant_id, admin_id, client_id, landscaper_id, creq_id)
    VALuES ('inProgress', 1, 4, 2, 3, 8);
